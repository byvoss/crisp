...
**For the Curious**: Wonder how CRISP gets from source code to this one CSS file? The complete build and distribution process is explained in [Chapter 18](./CH18-distribution.md).
